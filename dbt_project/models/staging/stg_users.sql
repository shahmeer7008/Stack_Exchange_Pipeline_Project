...
select
	...
	case when last_access_date is null then null else to_timestamp(last_access_date) end as last_access_date,
	case when last_modified_date is null then null else to_timestamp(last_modified_date) end as last_modified_date
