...
left join {{ ref('stg_questions') }} as q on t.tag_name ilike concat('%', q.tags_raw, '%')
left join question_answers as qa on q.question_id = qa.question_id
left join question_comments as qc on q.question_id = qc.post_id
group by t.tag_name
